...
export class Nibe1155Controller extends DataRecord<INibe1155Controller> implements INibe1155Controller {
    ...
    private _addHeaterPowerMax?: number;
    ...
    constructor (data: INibe1155Controller) {
        ...
        try {
            ...
            for (const a of Object.getOwnPropertyNames(data)) {
                ...
                } else if ( [ 'fSetpoint', 'fMin', 'fMax', 'tempSetpoint', 'tempMin', 'tempMax', 'addHeaterPowerMax' ].indexOf(a) >= 0 ) {
    ...
    public toObject (preserveDate = true): INibe1155Controller {
        ...
        if (this._addHeaterPowerMax !== undefined) { rv.addHeaterPowerMax  = this._addHeaterPowerMax; }
        return rv;
    }
    ...
    public get addHeaterPowerMax (): number {
        return this._addHeaterPowerMax;
    }
